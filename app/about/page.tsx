      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">Nilai-nilai yang menjadi fondasi dalam setiap langkah kami</p>
          </div>
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="opacity-90">Hubungi kami untuk informasi lebih lanjut tentang produk dan kemitraan</p>
          </div>
