      ...
      <div className="w-full max-w-sm">
        <div className="flex flex-col gap-6">
          ...
          <div className="text-center">
            ...
            <h1 className="text-2xl font-bold text-primary">UD. SEHATI</h1>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Masukkan email dan password untuk mengakses dashboard admin</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="flex flex-col gap-6">
                  <div className="grid gap-2">
                    ...
                    <Input
                      id="email"
                      type="email"
                      placeholder="admin@udsehati.com"
                      required
                      value={email}
          ...
          <div className="text-center text-sm text-muted-foreground">
            <p>Demo: admin@udsehati.com / admin123</p>
          </div>
        </div>
      </div>
    </div>
